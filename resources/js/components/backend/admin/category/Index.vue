                                            ...
                                            <div class="d-flex flex-nowrap align-items-center">
                                                <a href="instructor-edit-course.html"
                                                   class="avatar avatar-4by3 overlay overlay--primary mr-12pt">
                                                    <img :src="image_url+'/images/paths/angular_routing_200x168.png'"
                                                         alt="course"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-nowrap align-items-center">
                                                <a href="instructor-edit-course.html"
                                                   class="avatar avatar-4by3 overlay overlay--primary mr-12pt">
                                                    <img :src="image_url+'/images/paths/angular_testing_200x168.png'"
                                                         alt="course"
                                                         class="avatar-img rounded">
                                                    <span class="overlay__content"></span>
                                                </a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-nowrap align-items-center">
                                                <a href="instructor-edit-course.html"
                                                   class="avatar avatar-4by3 overlay overlay--primary mr-12pt">
                                                    <img :src="image_url+'/images/paths/typescript_200x168.png'"
                                                         alt="course"
                                                         class="avatar-img rounded">
                                                    <span class="overlay__content"></span>
                                                </a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-nowrap align-items-center">
                                                <a href="instructor-edit-course.html"
                                                   class="avatar avatar-4by3 overlay overlay--primary mr-12pt">
                                                    <img :src="image_url+'/images/paths/angular_200x168.png'"
                                                         alt="course"
                                                         class="avatar-img rounded">
                                                    <span class="overlay__content"></span>
                                                </a>
...
import useSortingScript from '../../../../src/composable/useSortingScript'
export default {
    ...
    setup(){
        ...
        let {flatpickr, flatpickrMain, listScriptMin, listScript} = useSortingScript()
